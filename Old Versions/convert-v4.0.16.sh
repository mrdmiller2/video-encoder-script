#!/usr/bin/env bash
# convert-v4.0.16.sh — Organize movie folders, transcode TV/movies to AV1/x265 MKV.
# Version: 4.0.16
...
#   Restart: existing .AV1.mkv / .x265.mkv outputs are validated (mkvmerge + duration + decode)
#     before skip; incomplete/broken outputs are removed and the source is re-encoded.
#
