...
**Current release:** `convert-v5.0.31F.sh` (v5.0.31F) — see [What's new in v5](#whats-new-in-v5)
...
The repo root holds the **current release** (`convert-v5.0.31F.sh`) and the **last v4
