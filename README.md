...
**Current release:** `convert-v5.0.2.sh` (v5.0.2) — see [What's new in v5](#whats-new-in-v5)
...
The repo root holds the **current release** (`convert-v5.0.2.sh`) and the **last v4
...
| `convert-v5.0.2.sh` | 5.0.2 | **Current** — `-p` accepts a single file directly (in addition to a directory or directory+trailing-glob) |
