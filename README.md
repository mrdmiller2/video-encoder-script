...
**Current release:** `convert-v5.0.33S.sh` (v5.0.33S) — see [What's new in v5](#whats-new-in-v5). Deploying fleet-wide 2026-08-02 (safe alongside in-progress jobs — running encodes keep using their already-loaded script version; only the next-job pickup uses the new one).
