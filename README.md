...
**Current release:** `convert-v5.0.32.sh` (v5.0.32) — see [What's new in v5](#whats-new-in-v5)
...
The repo root holds the **current release** (`convert-v5.0.32.sh`) and the **last v4
