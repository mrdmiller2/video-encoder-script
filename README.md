...
**Current release:** `convert-v5.0.29.sh` (v5.0.29) — see [What's new in v5](#whats-new-in-v5)
...
(v5.0.9 → v5.0.29) — what was wrong, why it mattered, how it was found and fixed —
...
The repo root holds the **current release** (`convert-v5.0.29.sh`) and the **last v4
