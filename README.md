...
**Current release:** `convert-v5.0.1.sh` (v5.0.1) — see [What's new in v5](#whats-new-in-v5)
...
The repo root holds the **current release** (`convert-v5.0.1.sh`) and the **last v4
...
| `convert-v5.0.1.sh` | 5.0.1 | **Current** — set-based resume (`convert-v5.done`): restarts fast-skip unchanged finished sources instead of positional queue anchor |
