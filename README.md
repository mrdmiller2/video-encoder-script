...
**Current release:** `convert-v5.0.12.sh` (v5.0.12) — see [What's new in v5](#whats-new-in-v5)
...
The repo root holds the **current release** (`convert-v5.0.12.sh`) and the **last v4
