...
**Current release:** `convert-v5.0.33I.sh` (v5.0.33I) — see [What's new in v5](#whats-new-in-v5). Deployed to Crystalight only as of 2026-07-30 (rest of fleet mid-test on v5.0.33H, full sync pending test completion).
