#!/usr/bin/env bash
# convert-v4.0.39.sh — Organize movie folders, transcode TV/movies to AV1/x265 MKV.
# Version: 4.0.39
...
validate_mkv_output() {
  ...
  # Structure before duration/decode: truncated MKVs often still identify + report full duration.
